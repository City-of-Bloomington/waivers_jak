...
<s:form action="entity" id="form_id" method="post" >
	...
	<tr>
	    <td>Name </td>
	    <td><s:textfield name="entity.name" value="%{entity.name}" size="30" maxlength="70" required="true" placeholder="last name, first name or business name"/> *</td>
	</tr>
	<tr>
	    <td>Title </td>
	...
	<s:if test="entity.hasWaiver()">
		...
		<td><a href="<s:property value='#application.url'/>waiver.action?id=<s:property value='entity.waiver_id' />"> Back To Waiver</a>	
	    </tr>
	</s:if>
	<tr>
	    <td>
